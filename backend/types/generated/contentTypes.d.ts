...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.Relation<'manyToOne', 'api::member.member'>;
    ...
    creatAt: Schema.Attribute.Date & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aboutContactnumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    aboutDescription: Schema.Attribute.Text;
    aboutEamil: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    aboutPill: Schema.Attribute.String & Schema.Attribute.Unique;
    aboutStrongPoints: Schema.Attribute.Component<
      'shared.about-strong-points',
      true
    >;
    aboutTitle: Schema.Attribute.Text & Schema.Attribute.Required;
    bannerDescription: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    bannerPill: Schema.Attribute.String & Schema.Attribute.Unique;
    bannerTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    blogPill: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    blogTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featureItem: Schema.Attribute.Component<'shared.feature-item', true>;
    featurePill: Schema.Attribute.String & Schema.Attribute.Unique;
    featureTitle: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    servicePill: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    profiePhoto: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    work: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fqa: Schema.Attribute.Component<'shared.fqa', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service.service'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    serviceStrongPoints: Schema.Attribute.Component<
      'shared.services-strong-points',
      true
    > &
      Schema.Attribute.Required;
